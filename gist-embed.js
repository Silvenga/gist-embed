...
// modified for custom use by: Mark Lopez 
// https://github.com/Silvenga/gist-embed

// Created as fuctions to have the ability to load on Ajax pages
function readGists() {
    ...
    $(function () {
        ...
        $('[data-gist-id]').each(function () {
            ...
            hideFooterOption = true; // force hiding of footer
            hideLineNumbersOption = false; // force line numbers
